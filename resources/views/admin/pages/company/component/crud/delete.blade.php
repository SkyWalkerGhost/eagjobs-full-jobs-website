<button type="button" 
        ...
        data-toggle="modal" 
        data-target="#delete_{{ $companies->id }}">
        <i class="fa fa-trash"></i>
</button>

<div    class="modal fade" 
        id="delete_{{ $companies->id }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-right">
                {!! Form::open(['action' => 
                    ['Admin\PageController@destroy_company', 'company_id' => $companies->id], 'method' => 'POST' ]) !!}
